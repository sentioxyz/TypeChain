...
//   estimateGas: {
//     ${values(contract.functions)
//       .map(codegenFunctions.bind(null, { overrideOutput: 'Promise<bigint>', codegenConfig }))
//   .join('\n')}
// };
    ...
    createImportsForUsedIdentifiers(
      {
        'type ethers': [
          ...
          'Signer',
          'Interface',
            'Result','EventFragment','FunctionFragment',
            'Provider',
          'LogDescription'
        ...
        'type ethers/providers': ['BlockTag', 'ContractRunner'],
